...
Shader "Custom/Water Wave" {
	Properties {
		...
		_WaterRefracEdge("Water Refraction Edge", Range(0,1))=0.01
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(v2f i) : SV_Target {
                ...
                float diff=saturate(abs(i.depth-ScreenZ)*_WaterRefracEdge*0.25);
				float foamWidth= clamp(1-(abs(i.depth-ScreenZ)*0.25),0,1);
				...
				float2 offset = bump.xy  *1000* _RefractionTex_TexelSize.xy;
				...
				//return _RefractionTex_TexelSize;
			//return waveCol;
			}
